...
def _enrich_sources(uir):
    ...
    for s in uir["sources"][:10]:
        ...
        result.append({
            ...
            "incident_id": r.get("_ground_truth", {}).get("incident_id"),
...
def serialize_uir(uir):
    return {
        ...
        "location": {"display_name": uir["location"]["display_name"], "lat": uir.get("lat"),
                     ...
                     "resolution_method": uir["location"].get("resolution_method", "unknown"),
        ...
        "ground_truth_incidents": uir.get("_ground_truth_incidents", []),
